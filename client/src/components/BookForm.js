...
export const BookForm = ({ book, onSubmit }) => {
  const { register, handleSubmit } = useForm( { defaultValues: { title: book ? book.title : "", author: book ? book.author : "", rating: book ? book.rating : "", language: book ? book.language : "", genre: book ? book.genre : "", description: book ? book.description : "", publisher: book ? book.publisher : "", publication_date: book ? book.publication_date : "", ISBN13: book ? book.ISBN13 : "", number_of_pages: book ? book.number_of_pages : "" } });
